...
export class MenuService {
 adminMenu: Menu[]  = [
   ...
   {  id: 2, name: '培养计划管理', iconType: 'edit', router: '/admin/user', _CHECKED: false, _SELECTED: false},
   {  id: 3, name: '学期管理', iconType: 'book', router: '/admin/user', _CHECKED: false, _SELECTED: false},
